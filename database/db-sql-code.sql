-- Types 'Client', 'Admin' and 'Employee' creation
CREATE TYPE public.account_type AS ENUM ('Client', 'Admin', 'Employee');
-- Set the owner of the type to the user 'chrsmendes'
ALTER TYPE public.account_type OWNER TO chrsmendes;
